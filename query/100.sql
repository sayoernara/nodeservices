{
    ...
    "transaction":{
        ...
        "insertSellMaster" : "INSERT INTO sayoerna_100_titik.transaksi (id_transaksi, tanggal, id_kasir, id_titik, nominal, modal, keuntungan, total_diskon_manual, pembayaran, kembalian) VALUES ( ? , NOW() , ?, ?, ?, ?, ?, ?, ?, ?)",
